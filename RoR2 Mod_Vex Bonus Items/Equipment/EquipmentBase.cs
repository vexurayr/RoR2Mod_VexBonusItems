...
namespace RoR2_Mod_Vex_Bonus_Items.Equipment
{
    ...
    public abstract class EquipmentBase
    {
        ...
        protected virtual void SetLogbookAppearance(float minDistance = 1f, float maxDistance = 2f)
        {
            ...
            ModelPanelParameters mpp = EquipmentModel.AddComponent<ModelPanelParameters>();
            ...
            mpp.focusPointTransform.SetParent(EquipmentModel.transform);

            mpp.cameraPositionTransform = new GameObject("CameraPosition").transform;
            mpp.cameraPositionTransform.SetParent(EquipmentModel.transform);
        }
