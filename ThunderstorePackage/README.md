...
|:-|-|------|-|
|![](https://raw.githubusercontent.com/vexurayr/RoR2Mod_VexBonusItems/567ae3b3a281f10e13bb62171dcbb143cbd26d95/Unity%20Files/Assets/Textures/Items/Sword%20of%20Looting/SwordOfLootingIcon.png) | **Sword of Looting** | When a teleporter boss would drop an item, drop `1` more item (`+1` item per stack). | Green |
|![](https://raw.githubusercontent.com/vexurayr/RoR2Mod_VexBonusItems/567ae3b3a281f10e13bb62171dcbb143cbd26d95/Unity%20Files/Assets/Textures/Items/Divine%20Ring/DivineRingIcon.png) | **Divine Ring** | Increase health per level by `5%` (`+5%` per stack), increase regeneration per level by `5%` (`+5%` per stack), increase damage per level by `5%` (`+5%` per stack), and increase experience gain per level by `500%` (`+500%` per stack). | Red |
